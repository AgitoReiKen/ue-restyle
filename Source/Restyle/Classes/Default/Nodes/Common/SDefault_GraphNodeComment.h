...
class SDefault_GraphNodeComment : public SGraphNodeResizable
{
public:
	SLATE_BEGIN_ARGS(SDefault_GraphNodeComment) {}
	SLATE_END_ARGS()
...
protected:
	...
	FVector2D CachedMouseMoveScreenSpace;
...
private:
	...
	float CachedNormalOpacity;
	float CachedSelectedOpacity;
