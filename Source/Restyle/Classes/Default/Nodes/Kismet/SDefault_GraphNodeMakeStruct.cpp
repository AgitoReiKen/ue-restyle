...
#include "SDefault_GraphNodeMakeStruct.h"
...
void SDefault_GraphNodeMakeStruct::Construct(const FArguments& InArgs, UK2Node_MakeStruct* InNode)
{
	SDefault_GraphNodeK2Default::Construct(SDefault_GraphNodeK2Default::FArguments(), InNode);
}

TSharedPtr<SGraphPin> SDefault_GraphNodeMakeStruct::CreatePinWidget(UEdGraphPin* Pin) const
{
...
bool SDefault_GraphNodeMakeStruct::IsPinEnabled(FOptionalPinFromProperty* InPropertyEntry) const
{
